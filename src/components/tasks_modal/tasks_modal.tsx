...
const TasksModal = (
    ...
    {
        tasksCount: number,
        checkboxColor_data: number
        onEditTasks: (tasksCount: number, checkboxColors: number) => void
        onCancel: () => void
    }) => {
        ...
        <div className={cl.modal}>
            ...
            <div className={cl.body}>
                ...
                <div className={cl.btns}>
                    ...
                    <button className={cl.btn} onClick={() => onEditTasks(Number(count), Number(checkboxColor))}>ОК</button>
                </div>
            </div>
        </div>
    )
